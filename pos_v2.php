              ...
              <div class="row">
                ...
                <form id="searchItemName">
                  <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="itemName" name="itemName" placeholder="Enter Item Name"  autocomplete="off">
                ...
                <div class="card-body">
                  <h4 class="card-title">POS</h4>
                    <!-- Left Section - Item Search and Details -->
                      <form id="searchForm">
                          <div class="form-group">
                                <label for="itemUniqueCode">Enter Item by Unique Code :</label>

                                
                                    <input type="text" class="form-control classy-input" id="itemUniqueCode" name="itemUniqueCode" placeholder="Search for items...">
...
// Handle form submission for searching items name
    $(document).on('input','#searchItemName', function(e) {
      e.preventDefault();
